	...
	<div class="container ">
		<div class="row">
			<div class="card-wrapper">
				...
				<div class="card fat">
					<div class="card-body">
						<h4 class="card-title"><img class="logo-2" src="https://i.ibb.co/WxXQ1CQ/LOGO.png" alt="" width="60" height="60"/>Diactology Teacher Registration </h4>
...
font-weight : bold;
							...
							<div class="form-group">
								<div class="form-group">
									...
									<div class="select">
                                        ...
                                        <option value="Pp">Pre-primary Education</option>
                                        <option value="p">Primary Education(Class 1st to Class 5th)</option>
                                        <option value="s">Secondary Education (Class 6 to Class 8th)</option>
                                        <option value="hs">Higher Secondary Education (Class 9th to 12th)</option>
                                        <option value="dc">Diploma Courses</option>
                                        <option value="bc">Bachelor Courses</option>
                                        <option value="mc">Master Courses</option>
                                        <option class="subcat" value="h"><b>Hobbies (Music , Dance etc)</b></option>
                                        <option class="subcat" value="c"><b>Coding</b></option>
                            ...
                            <div class="form-group">
								<label for="name">Preffered Subject</label>
								<input class="single-input" id="pincode" type="text" class="form-control" minlength="5" name="subject" required autofocus>
								<div class="invalid-feedback">
									You can Teach other subjects also.
								</div>
							</div>
							...
							<div class="form-group">
								<div class="custom-checkbox custom-control">
									...
									<label for="agree" class="custom-control-label">I agree to the <a href="https://didactology.in/tnc.html">Terms and Conditions</a></label>
									<div class="invalid-feedback">
										You must agree with our Terms and Conditions</a>
									</div>
								</div>
							</div>
