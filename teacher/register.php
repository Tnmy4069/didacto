	...
	<div class="container">
		<div class="card">
			...
			<div class="card-body px-lg-5 pt-0">
				...
				<form class="my-login-validation" novalidate="" method="POST" action="insert.php">
								...
								<div class="form-group">
									<div class="select">
										<select class="form-control" name="class" id="class">
											...
											<option value="h"><b>Hobbies (Music , Dance etc)</b></option>
											<option value="c"><b>Coding</b></option>
