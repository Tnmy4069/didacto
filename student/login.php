...
if(isset($_COOKIE['phone'])) {
    $phone =$_COOKIE['phone'];
      $sql = "Select phone form students where phone = '$phone'";
  ...
  header("location: https://didactology.in/teacher/dash/");}
}
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "Select * from students where phone='$username' AND password='$password'";
    $result = mysqli_query($conn, $sql);
    $num = mysqli_num_rows($result);
    if ($num == 1){
        $login = true;
...
<head>
	...
	<title>Didactology Student login</title>
...
<nav class="navbar navbar-collapse collapse navbar-right navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="https://didactology.in/new/ndidact/teacher/login.php">Teacher Login</a>
        </li>
