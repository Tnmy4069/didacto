                    ...
                    <div class="card-body">
                        <div class="account-settings">
                            <div class="user-profile">
                                ...
                                <h5 class="user-name"><?php echo "$sname $tlname"; ?></h5>
                        ...
                        <form method="post">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="fullName" placeholder="Enter full name" value="<?php echo $sname; ?>">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="eMail">Last year Percentage</label>
                                    <input type="number" class="form-control" id="eMail" placeholder="Previous Year Percentage" value="">
                                </div>
                                </form>
                            </div>
                        </div>
