  ...
  <div class="content u-flexCenter u-sizeViewHeightMin100">
    <div class="shareUrl u-verticalGrid u-marginAuto u-size1040">
      <header class="shareUrl-header">
        ...
        <p class="shareUrl-headerSubtext">When you reffer someone you both will 5% and 5% get discount on next Course Purchase</p>
      </header>
...
<!-- partial -->
  <script>
    ...
    shareUrl.value = "https://didactology.in/student/register.php?ref=<?php echo $sid; ?>";
