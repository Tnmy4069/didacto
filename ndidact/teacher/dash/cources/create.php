        ...
        <div class="container" id="form">
            ...
            <hr>
                ...
                <div class="form-group row">
                    <label for="cname" class="col-4 col-form-label">Cource Name</label>
                    <div class="col-8">
                ...
                <div class="form-group row">
                    <label for="csubject" class="col-4 col-form-label">Cource Subject</label>
                    <div class="col-8">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                ...
                <div class="form-group row">
                    <label for="cdesc" class="col-4 col-form-label">Cource Description</label>
                    <div class="col-8">
                        <textarea id="cdesc" name="cdesc" cols="40" rows="6" required="required" class="form-control"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="cduration" class="col-4 col-form-label">Cource Duration</label>
                    <div class="col-8">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                ...
                <div class="form-group row">
                    <label for="camt" class="col-4 col-form-label">Cource Amount</label>
                    <div class="col-8">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
