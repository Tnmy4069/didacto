          ...
          <div class="col">
            ...
            <div class="refer-form-content">
              ...
              <form action="#" method="post">
                ...
                <input value="https://didactology.in/new/ndidact/student/register.php?ref=<?php echo $phone; ?>" type="text" name="Your Name" placeholder="Your Friend Name" readonly>
                <p class="form-text text-muted">
                  Copy Link above and Share With your Friends
                </p>

                <label for="student">I know a Teacher</label>
                <input value="https://didactology.in/new/ndidact/teacher/register.php?ref=<?php echo $phone; ?>" type="text" name="Your Name" placeholder="Your Friend Name" readonly>
                <p class="form-text text-muted">
